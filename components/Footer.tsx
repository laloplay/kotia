...
import { Leaf, X, Link, Camera } from 'lucide-react';
  ...
  return (
    <footer className="bg-[#050810] pt-16 pb-8 px-6 border-t border-slate-800/50">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="md:col-span-1">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-3xl font-bold text-white tracking-wider">CENVIX</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto text-center pt-8 border-t border-slate-800 text-slate-600 text-sm">
        <p>&copy; {new Date().getFullYear()} CENVIX. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}