      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-8">
            CENVIX es una estación inteligente que recopila datos del campo mediante sensores de alta precisión y los analiza con inteligencia artificial avanzada. Transformamos la toma de decisiones tradicional en una herramienta de optimización predictiva, garantizando una productividad agrícola sostenible y eficiente.
          </p>
